...
hoverChangeExperience(
  ".bernhoeft",
  `Realizei o estágio na Bernhoeft, uma empresa de contabilidade. 
  Onde pela primeira vez tive experiência com a área de desenvolvimento
  front-end. Além do desenvolvimento frontend trabalhei na TechVirtus setor
  de desenvolvimento da empresa.`,
  "Suporte de TI",
  "Bernhoeft",
  "Fev 2019 - Jul 2020 (1 ano e 6 meses)"
);

hoverChangeExperience(
  ".sistemica",
  `Atualmente trabalho como Analista de Dados na Sistêmica Contabilidade,
  onde desenvolvo e implemento análises de dados, sistemas de coleta de dados
  e outras estratégias que otimizem a eficiência e a qualidade estatística.`,
  "Analista de Dados",
  "Sistêmica Contabilidade",
  "Jul 2021 - Presente (2 anos e 1 mês)"
);
